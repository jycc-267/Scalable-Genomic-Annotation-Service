...
class Config(object):
    ...
    # AWS SNS topics, vary by assignments
    AWS_SNS_JOB_REQUEST_TOPIC = f"arn:aws:sns:us-east-1:127134666975:{iam_username}_a17_job_requests"
    AWS_SNS_THAW_TOPIC = f"arn:aws:sns:us-east-1:127134666975:{iam_username}_a17_results_thaw"

    # AWS SQS queue name, vary by assignments
    AWS_SQS_REQUESTS_QUEUE_NAME = f"{iam_username}_a17_job_requests"

    # AWS DynamoDB annotation table
    AWS_DYNAMODB_ANNOTATIONS_TABLE = f"{iam_username}_annotations"

    # AWS DynamoDB annotation table secondary index
    ...
    # Test API keys for Stripe account
    STRIPE_PUBLIC_KEY = "pk_test_51QQZUsKobPzVXRJF8IKKLYoMIJzmuY0gwZVKBTiESXjGWTUmMGk15PezVu4nJHv7XAJHAT7DY1FINJX5RJ5NJOz300H54qFHOQ"

    # Test API keys for Stripe account
    STRIPE_SECRET_KEY = "sk_test_51QQZUsKobPzVXRJFgvAbgp7iOeOo1YFPOzrLCzoU33gbyAORiWARrHJbxo0isCPkD8q8W0VySpQJFvRAeLeaRxLJ00NXGuTzxY"

    # A PRICE Model for subscription
    STRIPE_PRICE_ID = "price_1QQZZRKobPzVXRJFt4Rs1dkV"
